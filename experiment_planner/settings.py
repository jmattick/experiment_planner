"""
Django settings for experiment_planner project.
...
ALLOWED_HOSTS = ['https://experiment-planner.herokuapp.com/']
...
ROOT_URLCONF = 'experiment_planner.urls'
...
WSGI_APPLICATION = 'experiment_planner.wsgi.application'
